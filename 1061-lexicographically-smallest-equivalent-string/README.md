...
<pre><strong><l-core>Input:</l-core></strong><l-core> s1 = "parker", s2 = "morris", baseStr = "parser"<br></l-core><strong><l-core>Output:</l-core></strong><l-core> "makkek"<br></l-core><strong><l-core>Explanation:</l-core></strong><l-core> Based on the equivalency information in s1 and s2, we can group their characters as [m,p], [a,o], [k,r,s], [e,i</l-core>].
